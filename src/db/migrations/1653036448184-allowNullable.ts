...
export class allowNullable1653036448184 implements MigrationInterface {
    name = 'allowNullable1653036448184'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "task" ("task_id" uuid NOT NULL DEFAULT uuid_generate_v4(), "title" character varying NOT NULL, "status" character varying NOT NULL DEFAULT 'to do', "user_id" character varying NOT NULL, "board_id" character varying NOT NULL, "description" character varying NOT NULL, "userIdId" uuid, "boardIdBoardId" uuid, CONSTRAINT "PK_721f914bb100703f201a77dd58f" PRIMARY KEY ("task_id"))`);
